...
3281-3282: 如果RSA用来加密, 则设置SSL\_kRSA;

3284-3285: 如何设置了临时DH的控制函数， 则设置SSL\_kDH;

3292-3295: 如果RSA用来加密或签名，或有RSA-PSS证书且TLS版本是1.2, 设置SSL\_aRSA;

3297-3298: 如果用来DSA证书，则设置SSL\_aDSS;

3301: 设置空算法标记；

3308-3327: 检查证书的key usage扩展信息，设置SSL\_aECDSA标记;

3331: 设置SSL\_kECDHE标记;

3335-3342: 设置PSK算法标记;

3345-3346: 设置非对称算法掩码和密钥生成算法掩码到s上.
